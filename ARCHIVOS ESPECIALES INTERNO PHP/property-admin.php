...
function wpestate_display_labels(){
    ...
    $property_interno_text                  =   stripslashes ( esc_html( get_option('wp_estate_property_interno_text') ) );
    ...
    <form method="post" action="">
        <table class="form-table">
            <tbody>
                ...
                <tr valign="top">
                    <th scope="row">Property Uso Interno Label</th>
                    <td>
                        <input  type="text" id="property_interno_text"  name="property_interno_text"   value="'.$property_interno_text.'" size="40"/>
                    </td>
                </tr>
