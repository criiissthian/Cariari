       ...
       <div class="panel-heading">
           <a data-toggle="collapse" data-parent="#accordion_prop_addr" href="#collapseTwo">
             ...
             <?php if($property_adr_text!=''){
                 ...
                 _e('Dirección de Propiedad','wpestate');
             }
             ?>
             </h4>    
           </a>
...
<?php if ( is_user_logged_in() && (current_user_can('administrator') || current_user_can('editor'))) { //only logged in user can see this ?>
<div>
<div class="panel-group property-panel" id="accordion_prop_interno">  
    <div class="panel panel-default">
        <div class="panel-heading">
             <?php                      
             if($property_interno_text=='') {
                 print'<a data-toggle="collapse" data-parent="#accordion_prop_interno" href="#collapseTen"><h4 class="panel-title" id="prop_int">'.__('Uso Interno').'  </h4></a>';
             }else{
                 print'<a data-toggle="collapse" data-parent="#accordion_prop_interno" href="#collapseTen"><h4 class="panel-title"  id="prop_int">'.$property_interno_text.'  </h4></a>';
             }
             ?>
        </div>
        <div id="collapseTen" class="panel-collapse collapse in">
          <div class="panel-body">
          <?php print estate_listing_interno($post->ID);?>
          </div>
        </div>
    </div>
</div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion_prop_floor_plans" href="#collapseflplan">
                <?php
                    print '<h4 class="panel-title" id="prop_ame">'.__('Planos', 'wpestate').'</h4>';
                ?>
            </a>
        </div>
