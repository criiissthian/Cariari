...
if (function_exists('icl_translate') ){
    ...
    $property_interno_text      =   icl_translate('wpestate','wp_estate_property_interno_text', esc_html( get_option('wp_estate_property_interno_text') ) );
    ...
    $property_interno_text      =   esc_html( get_option('wp_estate_property_interno_text') );
